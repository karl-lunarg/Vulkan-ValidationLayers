...
class BothRangeMap {
  ...
  private:
    ...
    constexpr static size_t kMapSize = std::max(sizeof(SmallMap), sizeof(BigMap));
    constexpr static size_t kMapAlign = std::max(alignof(SmallMap), alignof(BigMap));
    using Storage = typename std::aligned_storage<kMapSize, kMapAlign>::type;
